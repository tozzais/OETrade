...
public class PrivacyUtil {
    ...
    public static void showTwo(Context context,  OnDialogClickListener listener) {
        String str = "PERMISSIONS\n" +
                ...
                "Click Push privacy agreement to read more about Push agreement & Terms and conditions.\n"+
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            public void onClick(View widget) {
                WebViewActivity.launch(context,"Privacy Policy","https://www.websitepolicies.com/policies/view/plBUbbmc");
            }
