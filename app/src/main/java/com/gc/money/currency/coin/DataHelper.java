...
public class DataHelper {
     ...
     * @param datas
     */
    static void calculateRSI(ArrayList<KLineEntity> datas) {
        float rsi1 = 0;
        float rsi2 = 0;
        float rsi3 = 0;
        float rsi1ABSEma = 0;
     ...
     * @param datas
     */
    static void calculateKDJ(ArrayList<KLineEntity> datas) {
        float k = 0;
        float d = 0;
     ...
     * @param datas
     */
    static void calculateMACD(ArrayList<KLineEntity> datas) {
        float ema12 = 0;
        float ema26 = 0;
        float dif = 0;
        float dea = 0;
...
//            用（DIF-DEA）*2即为MACD柱状图。
     ...
     * @param datas
     */
    static void calculateBOLL(ArrayList<KLineEntity> datas) {
        for (int i = 0; i < datas.size(); i++) {
            KLineEntity point = datas.get(i);
            final float closePrice = point.getClosePrice();
            if (i == 0) {
     ...
     * @param datas
     */
    static void calculateMA(ArrayList<KLineEntity> datas) {
        float ma5 = 0;
        float ma10 = 0;
        float ma20 = 0;
     ...
     * @param datas
     */
    public static void calculate(ArrayList<KLineEntity> datas) {
        calculateMA(datas);
        calculateMACD(datas);
        calculateBOLL(datas);
        calculateRSI(datas);
    ...
    private static void calculateVolumeMA(ArrayList<KLineEntity> entries) {
        float volumeMa5 = 0;
        float volumeMa10 = 0;
